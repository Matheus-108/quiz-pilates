...
export default function QuizFlow() {
  ...
  const renderStep2Screen = () => (
      <div className="w-full max-w-lg text-center animate-in fade-in duration-500 flex flex-col items-center">
        <Button size="lg" className="w-full bg-[#E5398D] hover:bg-[#c22a7a] text-white rounded-full px-10 py-6 text-lg font-bold shadow-lg transform hover:scale-105 transition-transform mb-4">Atenção meninas</Button>
